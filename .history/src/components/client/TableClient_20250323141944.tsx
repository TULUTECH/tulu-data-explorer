...
import normalized_omp_data from "@/data/normalized_omp_data.json";
import { parseNormalizedOmpData } from "@/utils/utils/parseNormalizedOmpData";
import rawData from "@/data/normalized_omp_data.json";

const defaultData = parseNormalizedOmpData(rawData);
